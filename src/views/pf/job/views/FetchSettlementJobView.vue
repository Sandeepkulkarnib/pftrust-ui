    ...
    <v-row justify="center">
      <v-col>
        ...
        >
          <v-card>
            <v-card-title>
              Start a new Fetch Settlements Job
              <v-spacer></v-spacer>
              <v-icon
                  dark
              ...
              <v-row >
                <v-col>
                  <v-select
                      ...
                      :items="unitcodes"
                      label="Select UnitCodes to Fetch Settlements from"
                      multiple
                      chips
                      deletable-chips
        ...
        >
          <template v-slot:top>
            <v-toolbar
                flat
            >
              <v-toolbar-title>Fetch Settlement Jobs Execution History</v-toolbar-title>
              <v-spacer></v-spacer>
              <v-btn
                  color="primary"
                  dark
...
<script>
export default {
  name: "FetchSettlementJobView",
  data () {
    return {
      loading: false,
      startingJob: false,
      jobType: "fetch_settlement_job",
      dialog: false,
      newJobDialog: false,
      jobInProgress: false,
      headers: [
