<template>
  <v-card>
    ...
    >
      <v-card>
        <v-card-title>
          Reject Transfer Out Application
          <v-spacer></v-spacer>
          <v-icon
              small
              color="black darken-2"
          ...
          <v-row>
            <v-col>
              <v-checkbox v-model="confirmReject" color="primary">
                <template v-slot:label>
                  <div>
                    Please confirm that you want to reject this Transfer Out Application
                  </div>
                </template>
              </v-checkbox>
            </v-col>
    ...
    <v-card-title>
      ...
      >
        {{data === null ? "" : data.transferOutStatus}}
      </v-chip>
    </v-card-title>
    <v-divider></v-divider>
    <v-card-text class="ma-0 pa-0">
      <v-container fluid fill-height v-if="data !== null">
        ...
        <v-row class="pa-0 ma-0">
          ...
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.dueDate}}</p>
              <p>Due Date</p>
            </div>
          </v-col>
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.requestCreatedAt}}</p>
        ...
        <v-row class="pa-0 ma-0">
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.netCreditAmount}}</p>
          ...
          <v-col>
            <div>
              ...
              <p>No of years in PF MemberShip</p>
            </div>
          </v-col>
        </v-row>
        <v-row class="pa-0 ma-0">
        ...
        <v-row class="ma-0 pa-0">
          <v-col>
            <h4 class="text-decoration-underline">Alternate Contact Information:</h4>
          </v-col>
        </v-row>
        <v-row class="pa-0 ma-0">
          <v-col>
        ...
        <v-row class="ma-0 pa-0">
          <v-col>
            <h4 class="text-decoration-underline">From Account Details:</h4>
          </v-col>
        </v-row>
        <v-row class="pa-0 ma-0">
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.fromPfAccount}}</p>
              <p>From PF No:</p>
            </div>
          </v-col>
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.fromEpsAccount==""? "NA":data.fromEpsAccount}}</p>
              <p>From EPS No</p>
            </div>
          </v-col>
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.fromUan}}</p>
              <p>From UAN NO</p>
            </div>
          </v-col>
        </v-row>
        <v-row class="ma-0 pa-0">
          <v-col>
            <h4 class="text-decoration-underline">To Account Details:</h4>
          </v-col>
        </v-row>
        <v-row class="pa-0 ma-0">
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.toPfAccount}}</p>
              <p>To PF No:</p>
            </div>
          </v-col>
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.toEpsAccount==""? "NA":data.toEpsAccount}}</p>
              <p>To EPS No</p>
            </div>
          </v-col>
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.toUan}}</p>
              <p>To UAN NO</p>
            </div>
          </v-col>
        </v-row>
        <v-row class="ma-0 pa-0">
          <v-col>
            <h4 class="text-decoration-underline">Current Employer Details:</h4>
          </v-col>
        </v-row>
        <v-row class="pa-0 ma-0">
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.companyName}}</p>
              <p>Name</p>
            </div>
          </v-col>
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.companyAddressLine1}}</p>
              <p>Address Line 1</p>
            </div>
          </v-col>
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.companyAddressLine2}}</p>
              <p>Address Line 2</p>
            </div>
          </v-col>
        </v-row>
        <v-row class="pa-0 ma-0">
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.companyAddressLine3}}</p>
              <p>Address Line 3</p>
            </div>
          </v-col>
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.companyAddressLine4}}</p>
              <p>Address Line 4</p>
            </div>
          </v-col>
          <v-col>
        ...
        <v-row class="ma-0 pa-0">
          <v-col>
            <h4 class="text-decoration-underline">Transfer out Details:</h4>
          </v-col>
        </v-row>
        <v-row class="pa-0 ma-0">
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.type}}</p>
              <p>Transfer Out type</p>
            </div>
          </v-col>
          <v-col>
            <div>
        ...
        <v-row class="ma-0 pa-0">
          <v-col>
            <h4 class="text-decoration-underline">Current Trust/EPFO Bank Details:</h4>
          </v-col>
        </v-row>
        <v-row class="pa-0 ma-0">
          <v-col>
        ...
        <v-row class="pa-0 ma-0">
          <v-col>
            <div>
              <p class="font-weight-black mb-0 pb-0">{{data.branch}}</p>
              <p>Branch</p>
            </div>
          </v-col>
          <v-col>
        ...
        <v-row class="ma-0 pa-0">
          <v-col>
            <h4 class="text-decoration-underline">Payment Bank Details:</h4>
          </v-col>
        </v-row>
        <v-row class="ma-0 pa-0">
          <v-col>
        ...
        <v-row class="ma-0 pa-0">
          <v-col>
            <h4 class="text-decoration-underline">Transfer out Documents:</h4>
          </v-col>
        </v-row>
        <v-row class="pa-0 ma-0">
          <v-col>
            <div>
              ...
              :loading="downloadingAnnexurek"
              @click="downloadAnnexurek()">Download Annexure K</v-btn>
            </div>
          </v-col>
          <v-col>
            <div>
              ...
              @click="downloadWorksheet()">Download WorkSheet</v-btn>
            </div>
          </v-col>
          <v-col>
            <div>
              ...
              @click="downloadDispatchLetter()">Download Dispatch Letter</v-btn>
            </div>
          </v-col>
        </v-row>
      </v-container>
    ...
    <v-card-actions v-if="data !== null && data.isInProgress">
      ...
      <v-btn
          ...
          dark
          small
          :to="'/transfer-outs/' + $route.params.entityId + '/update'"
      >
        Edit Application
      </v-btn>
      <v-btn
...
export default {
  ...
  methods: {
    getDetails(){
      this.loading = true
      this.$store.dispatch("transferOutModule/fetchTransferOutDetails", this.$route.params.entityId)
          .then(response => {
            this.loading = false
    ...
    updatePaymentDetails(){
      ...
      if(isValid){
        ...
        this.$store.dispatch("transferOutModule/savePaymentDetails", data)
            .then(response => {
    ...
    rejectTransferOut(){
      ...
      this.$store.dispatch("transferOutModule/rejectTransferOutApplication", this.$route.params.entityId)
          .then(response => {
    ...
    downloadDispatchLetter() {
      ...
      this.$store.dispatch("transferOutModule/downloadTransferOutDispatchLetter", this.$route.params.entityId)
          .then(response => {
    ...
    downloadWorksheet() {
      ...
      this.$store.dispatch("transferOutModule/downloadTransferOutWorksheet", this.$route.params.entityId)
          .then(response => {
            let fileName = response.headers["x-suggested-filename"]
            fileDownload(response.data, fileName)
    ...
    downloadAnnexurek() {
      ...
      this.downloadingAnnexurek = true

      this.$store.dispatch("transferOutModule/downloadTransferOutAnnexurek", this.$route.params.entityId)
          .then(response => {
            let fileName = response.headers["x-suggested-filename"]
            fileDownload(response.data, fileName)
            this.downloadingAnnexurek = false
          })
          .catch(error => {
            console.log(error)
          })
    ...
    downloadFile(document){
      ...
      this.$store.dispatch("transferOutModule/downloadTransferOutDocument", document.path)
          .then(response => {
            let fileName = response.headers["x-suggested-filename"]
            fileDownload(response.data, fileName)
          })
    ...
    approveApplication(){
       ...
       this.$store.dispatch("transferOutModule/approveApplication", this.$route.params.entityId)
           .then(response => {
             this.requestingPaymentDetailsUpdate = false
             this.getDetails()
             this.statusMessage = response
             this.paymentDetailsRequestStatus = "success"
             this.transferoutStatus = true
           })
           .catch(error => {
             this.requestingPaymentDetailsUpdate = false
