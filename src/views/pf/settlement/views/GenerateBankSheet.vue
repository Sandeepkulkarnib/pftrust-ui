    ...
    <v-row>
      <v-col>
        ...
        >
          <template v-slot:top>
            <v-toolbar flat>
              <v-toolbar-title>Generate Bank Sheet for Settlements for NEFT Payment</v-toolbar-title>
            </v-toolbar>
...
export default {
  ...
  methods: {
    getSettlements(){
      ...
      this.loading = true
      this.$store.dispatch("settlementModule/getSettlementsForBankSheet", data)
          .then(response => {
            this.loading = false
    ...
    getBanks(){
      this.$store.dispatch("settlementModule/getBanks")
          .then(res => {
    ...
    generateBankSheet(){
      ...
      this.$store.dispatch("settlementModule/generateBankSheet", {
      ...
      .then(response => {
        ...
        this.downloadingBankSheet = false
