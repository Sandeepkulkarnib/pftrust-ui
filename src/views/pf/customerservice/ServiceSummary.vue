<template>
    <v-container>
        <v-row>
            <v-col>
                <v-toolbar flat>
                    <v-toolbar-title>Payback Summary</v-toolbar-title>
                    <v-spacer></v-spacer>
                </v-toolbar>
            </v-col>
            <v-spacer></v-spacer>
                    ...
                    <template v-slot:top>
                        <v-toolbar flat>
                            ...
                            <v-row>
                                ...
                                <v-col class="ma-0 pb-0"><v-toolbar-title style="font-size: 15px ;">Total Payback* : {{ totalValue + adminInterest
                                }}</v-toolbar-title></v-col>
                                <!-- <v-spacer></v-spacer>      -->
                            </v-row>
                        </v-toolbar>
...
export default {
    ...
    data() {
        return {
            ...
            { text: 'Fiscal Year', sortable: false, value: 'fisccal_year' },                
                ...
                { text: 'Inst. Rate', sortable: false, value: 'interesRate' },
    ...
    methods: {
        getDetails() {
            ...
            if(this.pfNumber !== ""){
                this.$store.dispatch("CustomerModule/servicesummary",this.pfNumber)
                    .then(response => {
